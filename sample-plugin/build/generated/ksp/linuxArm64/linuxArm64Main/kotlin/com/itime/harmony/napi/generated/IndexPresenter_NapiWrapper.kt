...
public fun IndexPresenter_attach_wrapper(env: napi_env?, info: napi_callback_info?): napi_value? =
    try {
    memScoped {
...
public fun IndexPresenter_showUser_wrapper(env: napi_env?, info: napi_callback_info?): napi_value? =
    try {
    memScoped {
        val argc = alloc<size_tVar>()
        argc.value = 1u
...
public fun IndexPresenter_detach_wrapper(env: napi_env?, info: napi_callback_info?): napi_value? =
    try {
    memScoped {
        val argc = alloc<size_tVar>()
        argc.value = 0u
...
public fun IndexPresenter_finalize(
  env: napi_env?,
  `data`: COpaquePointer?,
  hint: COpaquePointer?,
) {
