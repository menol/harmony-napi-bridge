          ...
          struct {
            ...
            struct {
              ...
              struct {
                ...
                libsample_plugin_KType* (*_type)(void);
                libsample_plugin_kref_com_itime_harmony_sample_ArkTsHttpRequest (*ArkTsHttpRequest)(const char* url, const char* method, const char* body, libsample_plugin_kref_kotlin_collections_Map headers);
                const char* (*get_body)(libsample_plugin_kref_com_itime_harmony_sample_ArkTsHttpRequest thiz);
                libsample_plugin_kref_kotlin_collections_Map (*get_headers)(libsample_plugin_kref_com_itime_harmony_sample_ArkTsHttpRequest thiz);
                ...
                libsample_plugin_kref_kotlin_collections_Map (*component4)(libsample_plugin_kref_com_itime_harmony_sample_ArkTsHttpRequest thiz);
                libsample_plugin_kref_com_itime_harmony_sample_ArkTsHttpRequest (*copy)(libsample_plugin_kref_com_itime_harmony_sample_ArkTsHttpRequest thiz, const char* url, const char* method, const char* body, libsample_plugin_kref_kotlin_collections_Map headers);
              ...
              struct {
                ...
                libsample_plugin_KType* (*_type)(void);
                libsample_plugin_kref_com_itime_harmony_sample_ArkTsHttpResponse (*ArkTsHttpResponse)(libsample_plugin_KInt status, const char* body, libsample_plugin_kref_kotlin_collections_Map headers);
                const char* (*get_body)(libsample_plugin_kref_com_itime_harmony_sample_ArkTsHttpResponse thiz);
                libsample_plugin_kref_kotlin_collections_Map (*get_headers)(libsample_plugin_kref_com_itime_harmony_sample_ArkTsHttpResponse thiz);
                ...
                libsample_plugin_kref_kotlin_collections_Map (*component3)(libsample_plugin_kref_com_itime_harmony_sample_ArkTsHttpResponse thiz);
                libsample_plugin_kref_com_itime_harmony_sample_ArkTsHttpResponse (*copy)(libsample_plugin_kref_com_itime_harmony_sample_ArkTsHttpResponse thiz, libsample_plugin_KInt status, const char* body, libsample_plugin_kref_kotlin_collections_Map headers);
