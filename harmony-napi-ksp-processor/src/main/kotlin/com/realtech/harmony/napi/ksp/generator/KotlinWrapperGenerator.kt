package com.realtech.harmony.napi.ksp.generator

import com.google.devtools.ksp.processing.CodeGenerator
import com.google.devtools.ksp.processing.Dependencies
import com.realtech.harmony.napi.ksp.mapper.TypeMapper
import com.realtech.harmony.napi.ksp.models.HarmonyModuleModel
...
class KotlinWrapperGenerator(private val codeGenerator: CodeGenerator) {
    ...
    fun generate(module: HarmonyModuleModel) {
        ...
        val packageName = "com.realtech.harmony.napi.generated"
    ...
    private fun generateInterfaceProxy(module: HarmonyModuleModel) {
        ...
        val fileContent = buildString {
            ...
            appendLine("import com.realtech.harmony.napi.runtime.utils.*")
            ...
            module.exportFunctions.forEach { func ->
                ...
                appendLine("        return com.realtech.harmony.napi.runtime.utils.runOnMainThread(env, jsObjRef, \"${func.functionName}\") { jsObjValue, funcVar ->")
                appendLine("            memScoped {")
