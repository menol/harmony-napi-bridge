...
class InitEntryGenerator(private val codeGenerator: CodeGenerator) {
    ...
    fun generate(modules: List<HarmonyModuleModel>) {
        ...
        val codeBlock = buildString {
            ...
            appendLine("    com.realtech.harmony.napi.runtime.utils.initMainThreadId()")
            appendLine("    com.realtech.harmony.napi.runtime.utils.initMainThreadRunner(env!!)")
            ...
            validModules.forEach { module ->
                ...
                if (!module.isObject) {
                    ...
                    appendLine("    com.realtech.harmony.napi.runtime.utils.ConstructorRegistry.refs[\"${module.className}\"] = ${module.className}_refVar.value!!")
