...
import com.realtech.harmony.napi.ksp.generator.InitEntryGenerator
import com.realtech.harmony.napi.ksp.generator.KotlinWrapperGenerator
import com.realtech.harmony.napi.ksp.generator.TypeScriptGenerator
import com.realtech.harmony.napi.ksp.models.HarmonyExportModel
import com.realtech.harmony.napi.ksp.models.HarmonyModuleModel
import com.realtech.harmony.napi.ksp.models.HarmonyParameterModel
import com.realtech.harmony.napi.ksp.models.HarmonyTypeModel
import com.realtech.harmony.napi.ksp.models.HarmonyPropertyModel
...
class HarmonyNapiProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        val moduleSymbols = resolver.getSymbolsWithAnnotation("com.realtech.harmony.napi.annotations.HarmonyModule")
            .filterIsInstance<KSClassDeclaration>()
            .toList()

        val extensionFileSymbols = resolver.getSymbolsWithAnnotation("com.realtech.harmony.napi.annotations.HarmonyExtensions")
